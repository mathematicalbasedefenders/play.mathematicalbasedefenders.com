                ...
                for (
                    ...
                    if (
                        ...
                        game.enemyRenderStatus[enemy.enemyNumber.toString()][
                            ...
                            initialWindowWidth / 2 + 80 * (enemy.sPosition - 5); // (enemy.sPosition / 10) * 800 + 560;
                    ...
                    if (
                        ...
                        if (
                            ...
                            scoreGainIndicator.x =
                                ...
                                80 *
                                    (currentGameData.currentGame
                                        .scoreGainIndicators[i].sPosition -
                                        5);
                        ...
                        game.scoreGainIndicatorRenderStatus[
                            ...
                            -24 *
                                (currentGameData.currentGame
                                    .scoreGainIndicators[i].ageInMilliseconds /
                                    100 -
                                    5) +
                            50;
                    } else {
        ...
        case "defaultMultiplayerMode": {
            {
                if (currentGameData.currentGame.dead) {
                    ...
                    for (
                        let i = 0;
                        i <
                        currentGameData.currentGame.enemiesSentIndicators
                            .length;
                        i++
                    ) {
                        let indicator =
                        ...
                        if (
                            ...
                            if (
                                ...
                                let enemiesSentIndicator = new PIXI.Text(
                                    currentGameData.currentGame
                                        .enemiesSentIndicators[i].content == "0"
                                        ? ""
                                        : currentGameData.currentGame
                                              .enemiesSentIndicators[i].content,

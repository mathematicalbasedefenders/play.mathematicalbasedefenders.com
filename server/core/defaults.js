...
function createNewCustomSingleplayerGameData(mode, roomID, gameMode, socket, settings) {
	let data = {
		id: roomID,
		mode: modes.SINGLEPLAYER,
		gameMode: gameMode,
			...
			players: {
				[socket.id]: {
					currentGame: {
						...
						// custom
						allowedComboTime: settings.allowedComboTime,
						enemyGenerationThreshold:1 - settings.enemyGenerationThreshold/100,
						enemyGenerationIntervalInMilliseconds:settings.enemyGenerationIntervalInMilliseconds,

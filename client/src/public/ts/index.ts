...
window.addEventListener("load", function () {
  ...
  new PopupNotification(
    ...
    <li><b>As of 0.4.10, to prevent abuse of server resources, please do not mash the keys on your keyboard, as it may lead to anticheat falsely flagging and disconnecting you. (Don't worry, getting flagging for this reason has no punishment)</b></li>
    </ul>
